...
<div class="login<?php echo htmlspecialchars($this->params->get('pageclass_sfx'), ENT_COMPAT, 'UTF-8');?>">
	...
	<form action="<?php echo JRoute::_('index.php'); ?>" method="post">
		...
		<fieldset>
			...
			<label><?php echo JText::_('COM_EXTERNALLOGIN_SERVER_LABEL'); ?></label>
			...
			<div class="clr"></div>
			<input type="submit" onclick="document.location.href=document.id('server-login').options[document.id('server-login').selectedIndex].value;return false;" class="button" value="<?php echo htmlspecialchars(JText::_('JLOGIN'), ENT_COMPAT, 'UTF-8'); ?>" />
		</fieldset>
	</form>
</div>
