...
class ExternalloginViewUsers extends JViewLegacy
{
	...
	protected function addToolbar() 
	{
		...
		$bar->appendButton('Popup', 'publish', 'COM_EXTERNALLOGIN_TOOLBAR_ENABLE_EXTERNALLOGIN', 'index.php?option=com_externallogin&amp;view=servers&amp;layout=modal&amp;tmpl=component', 875, 300, 0, 0, '');
		...
		$bar->appendButton('Popup', 'edit', 'COM_EXTERNALLOGIN_TOOLBAR_ENABLE_DISABLE_GLOBAL', 'index.php?option=com_externallogin&amp;view=servers&amp;layout=modal&amp;tmpl=component&globalS=1', 875, 300, 0, 0, '');
